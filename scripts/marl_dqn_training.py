"""
Multi-agent DQN training script.
"""
...
parser.add_argument(
    "--stop-episodes", type=int, default=200, help="Number of episodes to train."
)
parser.add_argument( # Not commonly used
...
if __name__ == "__main__":
    ...
    config = config.rollouts(num_env_runners=0, rollout_fragment_length=4)
    config = config.exploration(exploration_config={"final_epsilon": 0.0,})
    ...
    print(
        f"A {algo} checkpoint has been created inside the directory: "
